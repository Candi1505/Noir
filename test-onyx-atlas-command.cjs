...
assert.match(html, /onyx-atlas-command\.css\?v=20260921-team-directory-1/);
assert.match(html, /onyx-atlas-command\.js\?v=20260921-team-directory-1/);
...
assert.match(html, /onyx-atlas-castle-hunter-core\.js\?v=20260921-team-directory-1/);
assert.match(html, /onyx-atlas-castle-hunter\.js\?v=20260921-team-directory-1/);
...
assert.match(hunterWorker, /onyx-atlas-castle-hunter-core\.js\?v=20260921-team-directory-1/);
