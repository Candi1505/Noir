...
assert.match(html, /onyx-atlas-command\.js\?v=20260922-attacking-team-1/);
...
assert.match(html, /onyx-atlas-castle-hunter\.js\?v=20260922-vulnerable-names-1/);
...
assert.match(hunterSource, /matched the loaded team directory/);
...
assert.match(command.castleGlory(liveVan).source, /live Atlas ranks/i);
